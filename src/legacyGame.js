...
const WORLD_META={
  ...
  // ── 4권+ 단일 자음 (동물 친구) ──
  p:{phoneme:"/p/",letter:"P p",character:"Penny the Penguin",kr:"페니 펭귄",emoji:"🐧"},
  q:{phoneme:"/kw/",letter:"Q q",character:"Queenie the Queen",kr:"퀴니 여왕",emoji:"👸"},
  v:{phoneme:"/v/",letter:"V v",character:"Vince the Vulture",kr:"빈스 독수리",emoji:"🦅"},
  y:{phoneme:"/y/",letter:"Y y",character:"Yuki the Yak",kr:"유키 야크",emoji:"🐃"},
  z:{phoneme:"/z/",letter:"Z z",character:"Zara the Zebra",kr:"자라 얼룩말",emoji:"🦓"},
  // ── 끝소리 복습 ──
  "_end1":{phoneme:"end",letter:"끝소리",character:"Bus",kr:"버스",emoji:"🚌"},
  "_end2":{phoneme:"end",letter:"끝소리",character:"Bread Loaf",kr:"빵",emoji:"🍞"},
  // ── 단모음 word family (키워드 친구) ──
  "-at":{phoneme:"-at",letter:"-at",character:"Cat",kr:"고양이",emoji:"🐱"},
  "-an":{phoneme:"-an",letter:"-an",character:"Van",kr:"승합차",emoji:"🚐"},
  "-ad":{phoneme:"-ad",letter:"-ad",character:"Dad",kr:"아빠",emoji:"👨"},
  "-ap":{phoneme:"-ap",letter:"-ap",character:"Cap",kr:"모자",emoji:"🧢"},
  "-ig":{phoneme:"-ig",letter:"-ig",character:"Pig",kr:"돼지",emoji:"🐷"},
  "-it":{phoneme:"-it",letter:"-it",character:"Kit",kr:"키트",emoji:"🧰"},
  "-ill":{phoneme:"-ill",letter:"-ill",character:"Hill",kr:"언덕",emoji:"⛰️"},
  "-in":{phoneme:"-in",letter:"-in",character:"Pin",kr:"핀",emoji:"📌"},
  "-un":{phoneme:"-un",letter:"-un",character:"Sun",kr:"해님",emoji:"☀️"},
  "-ug":{phoneme:"-ug",letter:"-ug",character:"Bug",kr:"벌레",emoji:"🐛"},
  "-ut":{phoneme:"-ut",letter:"-ut",character:"Nut",kr:"견과",emoji:"🥜"},
  "-ub":{phoneme:"-ub",letter:"-ub",character:"Tub",kr:"욕조",emoji:"🛁"},
  "-og":{phoneme:"-og",letter:"-og",character:"Log",kr:"통나무",emoji:"🪵"},
  "-ox":{phoneme:"-ox",letter:"-ox",character:"Box",kr:"상자",emoji:"📦"},
  "-ot":{phoneme:"-ot",letter:"-ot",character:"Pot",kr:"냄비",emoji:"🍲"},
  "-op":{phoneme:"-op",letter:"-op",character:"Mop",kr:"대걸레",emoji:"🧹"},
  "-et":{phoneme:"-et",letter:"-et",character:"Net",kr:"그물",emoji:"🥅"},
  "-en":{phoneme:"-en",letter:"-en",character:"Pen",kr:"펜",emoji:"🖊️"},
  "-ell":{phoneme:"-ell",letter:"-ell",character:"Shell",kr:"조개껍데기",emoji:"🐚"},
  "-ed":{phoneme:"-ed",letter:"-ed",character:"Bed",kr:"침대",emoji:"🛏️"},
  // ── 매직-e · 장모음 family ──
  "-ake":{phoneme:"-ake",letter:"-ake",character:"Snake",kr:"뱀",emoji:"🐍"},
  "-ate":{phoneme:"-ate",letter:"-ate",character:"Gate",kr:"문",emoji:"🚪"},
  "-ame":{phoneme:"-ame",letter:"-ame",character:"Game",kr:"게임",emoji:"🎮"},
  "-ace":{phoneme:"-ace",letter:"-ace",character:"Space",kr:"우주",emoji:"🚀"},
  "-ike":{phoneme:"-ike",letter:"-ike",character:"Bike",kr:"자전거",emoji:"🚲"},
  "-ide":{phoneme:"-ide",letter:"-ide",character:"Slide",kr:"미끄럼틀",emoji:"🛝"},
  "-ime":{phoneme:"-ime",letter:"-ime",character:"Lime",kr:"라임",emoji:"🍋"},
  "-ive":{phoneme:"-ive",letter:"-ive",character:"Five",kr:"다섯",emoji:"5️⃣"},
  "-ule":{phoneme:"-ule",letter:"-ule",character:"Mule",kr:"노새",emoji:"🫏"},
  "-ube":{phoneme:"-ube",letter:"-ube",character:"Cube",kr:"큐브",emoji:"🧊"},
  "-une":{phoneme:"-une",letter:"-une",character:"Tune",kr:"멜로디",emoji:"🎵"},
  "-ure":{phoneme:"-ure",letter:"-ure",character:"Treasure",kr:"보물",emoji:"💰"},
  "-ute":{phoneme:"-ute",letter:"-ute",character:"Flute",kr:"플루트",emoji:"🪈"},
  "-ole":{phoneme:"-ole",letter:"-ole",character:"Hole",kr:"구멍",emoji:"🕳️"},
  "-ose":{phoneme:"-ose",letter:"-ose",character:"Rose",kr:"장미",emoji:"🌹"},
  "-ope":{phoneme:"-ope",letter:"-ope",character:"Rope",kr:"밧줄",emoji:"🪢"},
  "-one":{phoneme:"-one",letter:"-one",character:"Bone",kr:"뼈",emoji:"🦴"},
  // ── 장모음 팀 ──
  "-ee":{phoneme:"-ee",letter:"-ee",character:"Bee",kr:"꿀벌",emoji:"🐝"},
  "-eep":{phoneme:"-eep",letter:"-eep",character:"Sheep",kr:"양",emoji:"🐑"},
  "-eed":{phoneme:"-eed",letter:"-eed",character:"Seed",kr:"씨앗",emoji:"🌱"},
  "-eel":{phoneme:"-eel",letter:"-eel",character:"Wheel",kr:"바퀴",emoji:"🛞"},
  "-ay":{phoneme:"-ay",letter:"-ay",character:"Hay",kr:"건초",emoji:"🌾"},
  "-ai":{phoneme:"-ai",letter:"-ai",character:"Train",kr:"기차",emoji:"🚂"},
  "open_a":{phoneme:"a_e",letter:"a_e",character:"Baby",kr:"아기",emoji:"👶"},
  "-igh":{phoneme:"-igh",letter:"-igh",character:"Light",kr:"빛",emoji:"💡"},
  "-ie":{phoneme:"-ie",letter:"-ie",character:"Pie",kr:"파이",emoji:"🥧"},
  "open_i":{phoneme:"i_e",letter:"i_e",character:"Spider",kr:"거미",emoji:"🕷️"},
  "-oa":{phoneme:"-oa",letter:"-oa",character:"Boat",kr:"배",emoji:"⛵"},
  "-ow":{phoneme:"-ow",letter:"-ow",character:"Snow",kr:"눈",emoji:"❄️"},
  "-oe":{phoneme:"-oe",letter:"-oe",character:"Toe",kr:"발가락",emoji:"🦶"},
  "open_o":{phoneme:"o_e",letter:"o_e",character:"Robot",kr:"로봇",emoji:"🤖"},
  "-ea":{phoneme:"-ea",letter:"-ea",character:"Leaf",kr:"잎",emoji:"🍃"},
  "open_e":{phoneme:"e_e",letter:"e_e",character:"Key",kr:"열쇠",emoji:"🔑"},
  // ── 블렌드 ──
  "fr":{phoneme:"fr",letter:"fr",character:"Frog",kr:"개구리",emoji:"🐸"},
  "gr":{phoneme:"gr",letter:"gr",character:"Grapes",kr:"포도",emoji:"🍇"},
  "br":{phoneme:"br",letter:"br",character:"Bread",kr:"빵",emoji:"🥖"},
  "pr":{phoneme:"pr",letter:"pr",character:"Pretzel",kr:"프레첼",emoji:"🥨"},
  "fl":{phoneme:"fl",letter:"fl",character:"Flower",kr:"꽃",emoji:"🌸"},
  "gl":{phoneme:"gl",letter:"gl",character:"Glove",kr:"장갑",emoji:"🧤"},
  "bl":{phoneme:"bl",letter:"bl",character:"Blueberry",kr:"블루베리",emoji:"🫐"},
  "pl":{phoneme:"pl",letter:"pl",character:"Plane",kr:"비행기",emoji:"✈️"},
  "sm":{phoneme:"sm",letter:"sm",character:"Smile",kr:"미소",emoji:"😊"},
  "st":{phoneme:"st",letter:"st",character:"Star",kr:"별",emoji:"⭐"},
  "sw":{phoneme:"sw",letter:"sw",character:"Swan",kr:"백조",emoji:"🦢"},
  "sn":{phoneme:"sn",letter:"sn",character:"Snail",kr:"달팽이",emoji:"🐌"},
  "sl":{phoneme:"sl",letter:"sl",character:"Sled",kr:"썰매",emoji:"🛷"},
  "sp":{phoneme:"sp",letter:"sp",character:"Spoon",kr:"숟가락",emoji:"🥄"},
  // ── 소프트 c · g ──
  "soft_c":{phoneme:"c=s",letter:"c(s)",character:"City",kr:"도시",emoji:"🌆"},
  "soft_g":{phoneme:"g=j",letter:"g(j)",character:"Giraffe",kr:"기린",emoji:"🦒"},
  // ── 이중자음(digraph) ──
  "ch_":{phoneme:"ch",letter:"ch",character:"Chick",kr:"병아리",emoji:"🐤"},
  "_ch":{phoneme:"ch",letter:"ch",character:"Peach",kr:"복숭아",emoji:"🍑"},
  "sh_":{phoneme:"sh",letter:"sh",character:"Ship",kr:"배",emoji:"🚢"},
  "_sh":{phoneme:"sh",letter:"sh",character:"Fish",kr:"물고기",emoji:"🐟"},
  "th":{phoneme:"th",letter:"th",character:"Thumb",kr:"엄지",emoji:"👍"},
  "wh":{phoneme:"wh",letter:"wh",character:"Whale",kr:"고래",emoji:"🐋"},
  "ph":{phoneme:"ph",letter:"ph",character:"Photo",kr:"사진",emoji:"📷"},
  "ng":{phoneme:"ng",letter:"ng",character:"Ring",kr:"반지",emoji:"💍"},
  "ck":{phoneme:"ck",letter:"ck",character:"Duck",kr:"오리",emoji:"🦆"},
  "wr":{phoneme:"wr",letter:"wr",character:"Wrist Watch",kr:"손목시계",emoji:"⌚"},
  "kn":{phoneme:"kn",letter:"kn",character:"Knife",kr:"칼",emoji:"🔪"},
  // ── 이중모음 · 모음팀 ──
  "oi_oy":{phoneme:"oi/oy",letter:"oi/oy",character:"Coin",kr:"동전",emoji:"🪙"},
  "ou_ow":{phoneme:"ou/ow",letter:"ou/ow",character:"Cow",kr:"소",emoji:"🐄"},
  "au_aw":{phoneme:"au/aw",letter:"au/aw",character:"Paw",kr:"발바닥",emoji:"🐾"},
  "oo_short":{phoneme:"oo",letter:"oo",character:"Book",kr:"책",emoji:"📖"},
  "oo_ew":{phoneme:"oo/ew",letter:"oo/ew",character:"Moon",kr:"달",emoji:"🌙"},
  "ue_ui":{phoneme:"ue/ui",letter:"ue/ui",character:"Juice",kr:"주스",emoji:"🧃"},
  "y_long_i":{phoneme:"y=i",letter:"y(i)",character:"Fly",kr:"나비",emoji:"🦋"},
  "y_long_e":{phoneme:"y=e",letter:"y(e)",character:"Candy",kr:"사탕",emoji:"🍬"},
  // ── r 통제 모음 ──
  "ar":{phoneme:"ar",letter:"ar",character:"Shark",kr:"상어",emoji:"🦈"},
  "or":{phoneme:"or",letter:"or",character:"Corn",kr:"옥수수",emoji:"🌽"},
  "ir_er_ur":{phoneme:"ir/er/ur",letter:"ir/er/ur",character:"Bird",kr:"새",emoji:"🐦"}
};
const WORD_EMOJI={
